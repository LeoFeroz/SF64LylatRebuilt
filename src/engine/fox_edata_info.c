...
ObjectInfo gObjectInfo[] = {
  ...
  /* OBJ_SCENERY_VE1_WALL_1,  */  {(void*) NULL, 1, (ObjectFunc)          NULL,        Ve1Wall1Hitbox,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VE1_WALL_2,  */  {(void*) NULL, 1, (ObjectFunc)          NULL,        aVe1Wall2Hitbox,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VE1_WALL_3,  */  {(void*)     NULL, 0, (ObjectFunc)          NULL,        aVe1SceneryWall3Hitbox,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_VE1_HALLWAY_OBSTACLE,  */  {(void*)     NULL, 0, (ObjectFunc)          NULL,        aVe1HallwayObstacleHitbox,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_SCENERY_VE1_WATCH_POST,  */  {(void*)     NULL, 0, (ObjectFunc)          NULL,        aVe1WatchPostHitbox,  2500.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* OBJ_SCENERY_VE1_TEMPLE_ENTRANCE  */  {(void*)     NULL, 0, (ObjectFunc) Venom1_Ve1TempleEntrance_Update,        aVe1TempleEntranceHitbox,  1000.0f,  0, 0, 42, 0,   0.0f,  0 },
  ...
  /* OBJ_SCENERY_BO_POLE  */  {(void*)     NULL, 0, (ObjectFunc)          NULL,        aBoPoleHitbox,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  /* OBJ_SCENERY_BO_BUILDING  */  {(void*)     NULL, 0, (ObjectFunc)          NULL,        aBoBuildingHitbox,     0.0f,  0, 0, 40, 0,   0.0f,  0 },
  ...
  /* Null0           */  {(void*) NULL, 1, (ObjectFunc) NULL,             NULL,   0.0f,  0, 0, 0, 0,   0.0f,  0 },
  /* Null0           */  {(void*) NULL, 1, (ObjectFunc) NULL,             NULL,   0.0f,  0, 0, 0, 0,   0.0f,  0 },
  /* OBJ_ACTOR_CUTSCENE2 */  {(void*) ActorCutscene2_Draw, 1, (ObjectFunc) ActorCutscene2_Update,       gNoHitbox, 9999999999999999.0f,  0, 1, 39, 0,   0.0f,  0 }, //ActorCutscene2 On Rails Skybox ONLY
};
// clang-format on
