...
#define OBJ_EFFECT_MAX OBJ_ACTOR2_START
#define OBJ_ENV_MAX OBJ_ACTOR2_START
...
typedef enum ActorCutsceneModels {
    ...
    /* 1003 */ ACTOR_CS_TI_SKYBOX = 1003,
    /* 1004 */ ACTOR_CS_TI_GROUND = 1004,
    /* 1005 */ ACTOR_CS_FO_SKYBOX = 1005,
    /* 1006 */ ACTOR_CS_FO_GROUND = 1006,
    /* 1007 */ ACTOR_CS_SO_SKYBOX = 1007,
    /* 1008 */ ACTOR_CS_BO_ARENA = 1008,
    /* 1009 */ ACTOR_CS_BO_SKYBOX = 1009
